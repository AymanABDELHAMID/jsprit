...
- <battery_capacity> 
defines the total capacity in wh
- <function cs_type="X"> 
defines the charging function of the electric vehicle when charged at a station of type X
- 
...
Instances are named using the following convention: tcAcBsCcDE, 
...
- 
	D is 't' if the CSs are located using a p-median heuristic and '
	f' if the CSs were randomly located
